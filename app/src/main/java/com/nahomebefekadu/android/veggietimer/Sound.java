...
//set up to be able to play any sound that you send it
public class Sound
{
  ...
  public static synchronized Sound instance(Context context) {
    if (sInstance == null) sInstance = new Sound(context);
    return sInstance;
